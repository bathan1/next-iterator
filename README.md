...
where anything that is 'truthy' counts as true for these functions (e.g. [`filter`](./src/async-iterator/async.filter.ts)).

### Extras
Next Iterator also ships [extra helper functions](./src/ext-iterator/). They are exposed as standalone
